...
const PanelBooking = ({ item }) => {
  ...
  return (
    <>
      <div
        className={`xxxl:w-3/4 lg:w-4/5 flex justify-between bg-white-color shadow rounded-lg p-4 mb-4 [&.Declined]:hidden [&.Finished]:hidden ${item.status}`}
      >
        <div>
